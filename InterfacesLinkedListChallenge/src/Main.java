...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        album.addSong("Love don't mean a think", 4.22);
        ...
        album.addSong("I put the finder on you", 3.25);
        album.addSong("For those about to rock", 5.44);
        album.addSong("Lets go", 3.45);
        album.addSong("Inject the venom", 3.33);
        album.addSong("Snowballed", 4.51);
        album.addSong("Evil walks", 3.45);
        album.addSong("C.0.D", 5.25);
        ...
        while(!quit) {
            ...
            switch (action) {
                ...
                case 2:
                    ...
                    if(listIterator.hasPrevious())
                        System.out.println("Now plating " + listIterator.previous().toString());
                    else{
    ...
    private static void printMenu() {
        ...
        System.out.println("0 - to quit\n" +
                ...
                "3 - to replat the current song\n" +
                "4 - list songs in the playlist\n" +
                "5 - print avalaible actions\n." +
